...
public class Fighter extends Character {
    ...
    int randomStrength = random.ints(6, 10 + 1).findFirst().getAsInt();
    int randomVitality = random.ints(3, 7 + 1).findFirst().getAsInt();
    int randomIntelligence = random.ints(1, 5 + 1).findFirst().getAsInt();


    public Fighter(String name, Weapon currentWield, Clothing currentWearing) {
    ...
    public Fighter(String name, Weapon currentWield) {
