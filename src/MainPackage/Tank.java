...
public class Tank extends Character {
    ...
    int randomVitality = random.ints(6, 10 + 1).findFirst().getAsInt();
    int randomIntelligence = random.ints(3, 7 + 1).findFirst().getAsInt();


    public Tank(String name, Weapon currentWield, Clothing currentWearing) {
    ...
    public Tank(String name, Weapon currentWield) {
